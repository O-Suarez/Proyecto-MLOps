...
│                         wikipedia_genero_analisis and configuration for tools like black
│
...
│
└── wikipedia_genero_analisis   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes wikipedia_genero_analisis a Python module
    │
